...
class BlinkyGhost(Ghost):
    def __init__(self, x=0, y=0, cell_size=10, field=None, textures=None, pacman=None):
        time_to_movement_since_start = 3
        self.pacman = pacman
        super().__init__(x, y, cell_size=cell_size, field=field, textures=textures.get_texture("blinky"), time_to_movement_since_start=time_to_movement_since_start)
